...
function hexAGuess() {
  ...
  const reset = () => {
	...
	return (
		<main className='grid grid-cols-3 items-center m-auto w-screen h-full p-4 justify-center gap-6 bg-neutral-900'>
			<Link href={"/"}><span className="text-slate-50 hover:text-emerald-600 font-semibold p-3 cursor-pointer">Home</span></Link>
